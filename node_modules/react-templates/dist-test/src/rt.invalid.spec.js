...
var omitStack = function omitStack(err) {
    return _.omit(err, 'stack', 'toIssue');
};

module.exports = {
    runTests: function runTests(test, basePath) {
        var dataPath = path.resolve(basePath, 'invalid');
        ...
        test('invalid tests', function (t) {
            ...
            function check(testFile) {
                ...
                var html = testUtils.readFileNormalized(filename);
                var error = null;
                try {
